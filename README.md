...
<p align="center">
  ...
  <img alt="Crate version 0.2.0" src="https://img.shields.io/badge/crate-0.2.0-2a4e66?style=flat-square">
</p>
...
curl --proto '=https' --tlsv1.2 -LsSf \
  https://github.com/kabudu/qatq/releases/download/v0.2.0/qatq-installer.sh | sh
```

On Windows:

```powershell
powershell -ExecutionPolicy Bypass -c "irm https://github.com/kabudu/qatq/releases/download/v0.2.0/qatq-installer.ps1 | iex"
```
